...
layer = qgis.core.QgsVectorLayer(r'C:\PSU\geog489\lesson3\lessonData\TM_WORLD_BORDERS-0.3.shp')
...
qgis.core.QgsVectorFileWriter.writeAsVectorFormat(centroidLayer, r'C:\PSU\geog489\lesson4\lessonData\centroids.gpkg', "utf-8", layer.crs(), "GPKG") 
qgis.core.QgsVectorFileWriter.writeAsVectorFormat(bufferLayer, r'C:\PSU\geog489\lesson4\lessonData\buffers.gpkg', "utf-8", layer.crs(), "GPKG")
